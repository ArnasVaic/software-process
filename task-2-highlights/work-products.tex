...
\describeWorkProd{Ticket}{\hl{Tai dokumentas, užregistruotas užduočių sekimo platformoje („Jira“), kuriame privalo būti ši informacija:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Aprašas - išsamus tekstas aprašantis užduotį, jame \hl{atskleidžiami funkciniai ir nefunkciniai užduoties reikalavimai.}
    \item \hl{Statusas - nusako kokioje stadijoje yra užduotis.} Gali turėti tik viena iš šių reikšmių:
    \begin{itemize}
