...
\begin{figure}[H]%[htpb!]
    \centering
    % \includegraphics[width=0.75\linewidth]{etc/diagram.png}
    \includegraphics[width=\linewidth]{etc/diagram.png}
\end{figure}
\end{landscape}
% \begin{figure}[htbp]
%     \centering
%     \includesvg[width=0.75\columnwidth]{etc/export.svg}
%     
% \end{figure}
...
\newpage
\subsection{PRO/CLIENT. Client Engagement Process }
\begin{table}[h!]
...
\newpage
% TODO:
\subsection{PRO/BACK. Backlog drafting} % Aranas
\begin{table}[h!]
\begin{tabular}{l|p{0.725\textwidth}}
\hline
